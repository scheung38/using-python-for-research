...
# and the counter function defined in part 1c has been loaded. Use
# these to return a dictionary consisting of the count of each
...
from Week1_BasicsOfPython3.ex1c import counter
